class Report::ReportQueryController < ApplicationController  
  ...
  #kpi_name
  def chart
    # template = Rms::ReportTemplateSet.find(:first,:conditions=>{:template_id=>params[:id],:chart_seq =>params[:chart_seq]})
    template = Rms::ReportTemplateSet.find(:first,:conditions=>{:template_id=>params[:id],:id=>params[:chart_seq]})
  ...
  def get_kpilist_data
    ...
    netlocGrnas = Rms::ReportTemplate.find(params[:id])
