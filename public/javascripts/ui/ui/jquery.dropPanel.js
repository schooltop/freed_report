    ...
    $.extend($.fn, {
        dropPanel: function(o, callback) {
            ...
            $(this).each(function() {
                ...
                var html = '<div class="dropPanel"><input type="text" class="dropPanel_txt" name="' + select.attr("name") + '" readonly="readonly" value="'+ select.val() +'" /></div>';
        ...
        adjustViewport: function(dropPanel) {
            ...
            if(panelContent.width() < $('.dropPanel').width())
            	$(this).next('.panelContent').css({ width: $(this).width() + 24 });
