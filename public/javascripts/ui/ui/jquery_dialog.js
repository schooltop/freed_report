...
var JqueryDialog = {
	...
	init:function(dialogTitle, iframeSrc, iframeWidth, iframeHeight, isSubmitButton, isCancelButton, isDrag){
		...
		//header left
		_jd_dialog_m_h.append("<span id='jd_dialog_m_h_l' style='background:#9ED2EB none repeat scroll 0 0;' class='f4'>" + dialogTitle + "</span>");
		...
		//bottom
		_jd_dialog_m.append("<div id='jd_dialog_m_t' class='f4' style='background-color:"+JqueryDialog.cBottomBackgroundColor+";'></div>");
		var _jd_dialog_m_t = $("#jd_dialog_m_t");
		if(isSubmitButton){
			_jd_dialog_m_t.append("<span><input id='jd_submit' class='submit ui-corner-all ui-state-defaut ' value='"+JqueryDialog.cSubmitText+"' type='button' onclick='JqueryDialog.Ok();' /></span>");
		}
		if(isCancelButton){
			_jd_dialog_m_t.append("<span class='jd_dialog_m_t_s'><input id='jd_cancel' class='button ui-corner-all ui-state-defaut' value='"+JqueryDialog.cCancelText+"' type='button' onclick='JqueryDialog.Close();' /></span>");
		}
